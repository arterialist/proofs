...
graph deficit for the [actual prime shifts](prime-shift-weighted-schur-window-asymptotic.md).
...
\]
The [exact edge calculation](odd-prime-terminal-band-phase-transfer.md)
gives
\[
...
can pay the full prime row. The [growing exceptional-prime construction](odd-prime-graph-growing-exceptional-phase-obstruction.md)

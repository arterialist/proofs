...
[CompletedZetaPoleCorrections.lean](BuildingBlocks/CompletedZetaPoleCorrections.lean) proves nine theorems. For s distinct from 0 and 1, and with actual xi(s) nonzero, it proves

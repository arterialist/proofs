...
The related [divisor-conjugated successor](../successor-and-division/divisor-successor-overlap.md) retains a different, signed Gram structure. Neither result supplies the missing global sign in the [actual arithmetic criterion](../zeta-and-zeros/actual-critical-sign-criterion.md).

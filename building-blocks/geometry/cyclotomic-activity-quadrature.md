...
The [angular height and insertion theorem](../analytic-methods/angular-height-boundary.md) supplies the height consumer and positive-birth allowance. Here all derivatives retain the full monic polynomial, including $\Phi_1$. All angular coordinates belong to $\mathbb R/\mathbb Z$, with total length one. Define

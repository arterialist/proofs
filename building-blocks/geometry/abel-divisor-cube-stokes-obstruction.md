...
The underlying complete LCM-fiber identity and exact terminal reserve $M(N)(M(N)-1)$ are already compiled in [FactorialTerminalReserve.lean](../../formalization/BuildingBlocks/FactorialTerminalReserve.lean). The tensor-complex commutator, relative-complex interpretation, and explicit Morse matching in this note are reviewed written mathematics and remain to be formalized.

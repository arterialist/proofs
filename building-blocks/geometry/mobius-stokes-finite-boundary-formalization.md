...
[`MobiusStokesFiniteBoundary.lean`](../../formalization/BuildingBlocks/MobiusStokesFiniteBoundary.lean) now formalizes the finite algebra from [the future-boundary note](mobius-stokes-future-boundary-and-hard-reservoir.md) without a prime-split hypothesis. It makes no capacity, asymptotic, or RH claim.

...
The module [PhysicalPrimeArrivalRegularity.lean](BuildingBlocks/PhysicalPrimeArrivalRegularity.lean) uses the literal exterior source and complete arrival defined in `PhysicalGroundPrimeArrival`:
\[

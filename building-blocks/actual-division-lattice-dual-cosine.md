...
The proved [mean-removal refinement](actual-coherent-successor-quadrature-refinement.md) gives the following stronger sufficient criterion using an unsigned error margin:

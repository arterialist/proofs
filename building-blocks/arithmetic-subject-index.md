...
[ChargeFrozenIntegrability](BuildingBlocks/ChargeFrozenIntegrability.lean) adds the literal frozen source's global L¹ membership and absolute convergence of every real-frequency Fourier integral, with [precise scope](frozen-source-fourier-integrability.md). The N-dependent majorant does not provide the original RH estimate.

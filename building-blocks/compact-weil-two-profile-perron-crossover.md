...
[score-matched affine gap](theta-score-matched-affine-gap.md), put
\[
...
[conditional edge estimator](theta-affine-comparison-conditional-edge-energy.md).
The [radius-transport obstruction](theta-common-score-radius-transport-obstruction.md)

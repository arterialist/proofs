...
Use the Hilbert completion and the actual-source estimates (5), (7)–(10) from [actual-source-mixed-dirichlet-completion.md](actual-source-mixed-dirichlet-completion.md). Its norm is
$$

...
```
The first-Riesz calculation in the [distinct-prime sign criterion](../prime-distribution/distinct-prime-sign-criterion.md), by absolute Fubini for $\Re s>1$, gives
```math

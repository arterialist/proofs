...
[ChargeFrozenFourier](../../formalization/BuildingBlocks/ChargeFrozenFourier.lean) formalizes the
...
[ChargeFrozenIntegrability](../../formalization/BuildingBlocks/ChargeFrozenIntegrability.lean).
...
[growing-product admission bound](../prime-history/compact-euler-growing-product-admission-bound.md).
It supplies its source-identification obligation. The [uniform spectral
majorant and actual logarithmic moment](../weil-and-spectral/frozen-source-spectral-logarithmic-bound.md)
are now formalized separately. [Physical Plancherel identification](../dynamics-and-feedback/frozen-source-exact-plancherel.md)

...
The module [ActualArchimedeanFactor.lean](../../formalization/BuildingBlocks/ActualArchimedeanFactor.lean) uses mathlib's actual `Complex.Gamma`, `Complex.Gammaℝ`, `riemannZeta`, `completedRiemannZeta` and pole-free `completedRiemannZeta₀`. Its gamma factor is
\[

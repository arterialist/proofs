...
To connect this literally to [Suzuki's coefficient variation](suzuki-coefficient-prime-history-variation.md), let \(c_\omega(n)\) be its finite divisor-sum coefficient and form the odd finite path
\[

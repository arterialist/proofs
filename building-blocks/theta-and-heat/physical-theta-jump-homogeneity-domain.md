...
[PhysicalThetaJumpHomogeneity.lean](../../formalization/BuildingBlocks/PhysicalThetaJumpHomogeneity.lean) uses the published actual theta edge masses and complete continuous/prime energies. For every real function \(h\), scalar \(c\), and displacement \(a\), it proves
\[

...
Its Fourier transform is $\partial_y|\Xi(x+iy)|^2$; see the [shifted Fourier identities](../prime-distribution/shifted-fourier-density.md). Folding the $a$ integral by evenness gives the exact expansion

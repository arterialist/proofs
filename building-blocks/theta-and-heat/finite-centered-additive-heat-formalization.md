...
| --- | --- |
| [AdditivePairBalance](../../formalization/BuildingBlocks/AdditivePairBalance.lean) | Physical=twice additive minus balance kernel and complete finite signed Gram; balance quadratic has both signs. |
| [AdditiveHeatWeight](../../formalization/BuildingBlocks/AdditiveHeatWeight.lean) | Positive cosh-series bound and pi/4 comparison of the heat and physical Fourier weights. |
| [AdditiveHeatGamma](../../formalization/BuildingBlocks/AdditiveHeatGamma.lean) | Classical gamma modulus squared pi/cosh(pi xi), via reflection and conjugation. |
| [AdditiveHeatPairing](../../formalization/BuildingBlocks/AdditiveHeatPairing.lean) | Exponential integrability/pairing, signed finite heat Gram, actual L2 classes and LipschitzWith 1/2 on x>=1. |
| [ActualFiniteHeatSource](../../formalization/BuildingBlocks/ActualFiniteHeatSource.lean) | Literal Lambda source, continuum cutoff, origin, successor and finite square membership. |
| [ActualHeatDensityPairing](../../formalization/BuildingBlocks/ActualHeatDensityPairing.lean) | Both rectangular Fubini steps, explicit density square and complete actual source Gram. |

...
Consume the checked family in [actual core explicit weil cross family](../weil-and-spectral/actual-core-explicit-weil-cross-family.md), with its scaling kernel denoted here by $K_{\rm sc}$:
$$

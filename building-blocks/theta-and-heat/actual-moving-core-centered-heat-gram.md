...
At every integer cutoff \(X=N\ge1\), [ActualCompactHeatEndpoint.lean](../../formalization/BuildingBlocks/ActualCompactHeatEndpoint.lean)
...
\]
The [exact density-cell decomposition](../goldbach/goldbach-additive-source-consumer.md#4-preserve-continuous-density-cells-before-entering-the-source-norm) gives
\[
...
At integer cutoffs, [ActualCompactHeatEndpoint.lean](../../formalization/BuildingBlocks/ActualCompactHeatEndpoint.lean)
...
Let \(\Theta=\sup\{\Re\rho:\zeta(\rho)=0,\ 0<\Re\rho<1\}\). The [actual zero-abscissa estimate](../weil-and-spectral/zero-abscissa-scattering-growth.md) gives

...
to the [local occupation diagonal](../weil-and-spectral/bost-connes-weil-local-occupation-diagonal.md).
...
[ActualTerminalPrimeTraceFinite.lean](../../formalization/BuildingBlocks/ActualTerminalPrimeTraceFinite.lean)
...
ground representation. The [actual positive factorial potential](../factorial-and-renewal/factorial-ground-state-original-l2-domain.md)
...
as used in the [actual packet phase proof](../goldbach/actual-centered-packet-lag-autocorrelation.md#a-critical-zero-forces-a-signed-actual-packet-phase).
...
[the actual core screw-increment readout](../weil-and-spectral/actual-core-screw-increment-readout.md)
and the [rational screw matrices](../goldbach/goldbach-factorial-rational-screw-matrices.md).

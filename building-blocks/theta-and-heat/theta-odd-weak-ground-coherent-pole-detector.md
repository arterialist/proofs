...
[successor scaling kernel](../successor-and-division/successor-feedback-kernel-scaling.md), put
...
\[
 ...
 \tag{11}
\]
The [kernel Mellin calculation](../zeta-and-zeros/actual-Abel-feedback-Mellin-kernel.md)
...
Under RH, the [successor-feedback converse](../successor-and-division/successor-feedback-RH-converse.md)
...
claimed. [OddWeakGroundPrimeReflectionFinite.lean](../../formalization/BuildingBlocks/OddWeakGroundPrimeReflectionFinite.lean)

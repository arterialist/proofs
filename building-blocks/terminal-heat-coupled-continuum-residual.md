...
[continuum-prime square note](suzuki-odd-continuum-prime-square-and-arithmetic-remainder.md).
...
to \(5/4\). As the [rational pole-factor note](rational-scattering-pole-factor.md)

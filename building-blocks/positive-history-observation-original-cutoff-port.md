...
In contrast, the [division-lattice remainder](finite-division-lattice-port-cancellation.md) is
$$
...
Combining the [positive integer-birth interpolation](actual-integer-birth-positive-quadrature.md) with (16), the original-metric finite-source identity is finally
$$
\boxed{
E(e^{-t})=

...
For clarity, this is a statement about the **raw prime graph**. In the [actual odd continuum decomposition](suzuki-odd-continuum-prime-square-and-arithmetic-remainder.md),

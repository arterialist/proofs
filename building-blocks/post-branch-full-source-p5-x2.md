...
[literal simultaneous row](simultaneous-nonendpoint-remainder-adversarial-audit.md#literal-row-and-normalization),
...
[prime-density expansion](simultaneous-nonendpoint-remainder-adversarial-audit.md#1-prime-main-term-and-second-log-remainder)
and its [lower-atom convention](simultaneous-nonendpoint-remainder-adversarial-audit.md#2-moving-ceiling-and-lower-atom).
...
The [checker](verification/post_branch_full_source_p5_x2.py) constructs
...
[PostBranchFullSourceFinite.lean](BuildingBlocks/PostBranchFullSourceFinite.lean).

...
Use the [published literal sampled row](simultaneous-nonendpoint-remainder-adversarial-audit.md#literal-row-and-normalization)
...
(1).  The [checker](verification/post_branch_total_admission_p5_x2.py)

...
[Angularly collective transfer, equations (7)--(8)](angularly-collective-fixed-core-transfer-obstruction.md#2-exact-joint-density-matching).
...
Formula (8) is
[Angularly collective transfer, equation (9)](angularly-collective-fixed-core-transfer-obstruction.md#3-finite-angular-mixing-before-crossing).
The boundedness of \(x\mapsto B_Rx/\rho\) and compactness after the core
form embedding are equations (14)--(15) of the
[weighted crossing theorem](theta-groundstate-bounded-weighted-crossing.md#the-weighted-crossing-operator).

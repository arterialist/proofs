...
See [DLMF 27.6.1](https://dlmf.nist.gov/27.6.E1). Equation (1) is also formalized as `sum_weightedCurrent` in [BirthDivisorCoupling](BuildingBlocks/BirthDivisorCoupling.lean). The coordinates $d=1,2$ vanish identically, since $n-1$ and $n+1$ have the same parity.

...
Its diagonal term in (9) is bounded by the corresponding spectral-band probability and tends to zero after $X\to\infty$, then $\varepsilon\downarrow0$, by the [continuous limiting history law](haar-profile-all-order-moments.md#6-the-continuous-limiting-law-and-thin-fixed-bands).

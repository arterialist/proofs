...
$Q(g_2)=1+\ell/\sqrt2-2\sqrt2$ and $Q(Sg_2)=-\pi A/4$. Strict positivity also follows from the [natural-cutoff charge certificate](natural-cutoff-successor-primitive.md).

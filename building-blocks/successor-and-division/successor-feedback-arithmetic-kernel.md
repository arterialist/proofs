...
[the factorial cumulative note](../zeta-and-zeros/actual-W-positive-primitive-analysis.md).
...
The notation $W_r(n)$ in this chapter is the birth coefficient $d_r(n)$ of [the factorial-division expansion](../factorial-and-renewal/actual-Abel-factorial-division-positivity.md); it is not the quadratic W readout. The potential $F$ and the signed adjoint measure provide a separate endpoint-versus-cell formulation of the same feedback.

...
This bound controls a specified part of a signed hyperbola sum. Its finite arithmetic identities are verified in [Lean](../../formalization/BuildingBlocks/HyperbolaProduct.lean). The analytic argument below is a written proof using classical estimates. No mathematical originality or first-formalization claim is made; the exact statement's publication priority is unresolved. It does not improve a bound for the complete prime-counting error or prove RH.

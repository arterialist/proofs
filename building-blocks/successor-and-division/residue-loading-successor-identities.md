...
Here the braces mean the ordinary fractional part, including value zero at exact division. Every prime power remains through the actual von Mangoldt function. [ResidueLoadingSuccessor.lean](../../formalization/BuildingBlocks/ResidueLoadingSuccessor.lean) formalizes this literal definition and its two successor identities.

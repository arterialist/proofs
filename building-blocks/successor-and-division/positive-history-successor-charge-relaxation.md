...
The [exact scalar charge law](../dynamics-and-feedback/actual-source-causal-charge-law.md) supplies the exact actual-source formula
$$
...
$$
This corollary consumes their scalar derivation rather than repeating it. The [natural-cutoff proof](../prime-history/natural-cutoff-positive-history-charge.md) establishes strict negative mass uniformly over every $N\ge2$, every finite or infinite prime cutoff $P\ge2$, and every positive time. Section 4 retains the separate exponential-decay method for the eventual sign.

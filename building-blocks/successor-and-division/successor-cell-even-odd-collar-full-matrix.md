...
\(h=\log2\). In the [complete successor-cell space](../weil-and-spectral/compact-weil-successor-cell-refinement.md),
put
\[
...
shown in the [successor-cell form theorem](../weil-and-spectral/compact-weil-successor-cell-refinement.md).

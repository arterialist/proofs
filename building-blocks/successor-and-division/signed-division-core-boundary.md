...
Retain the actual kernels in [the successor-feedback arithmetic proof](successor-feedback-arithmetic-kernel.md) and [the Abel factorial/division proof](../factorial-and-renewal/actual-Abel-factorial-division-positivity.md):
$$
 q_0(n)=n^{-1/2},\qquad

...
[proved all-index bound](../factorial-and-renewal/exact-seed-renewal-asymptotic.md) is
$$
0<R_j\le(j+1)^{-1/2}.
\tag{2}
$$
...
[the classical positive-Laplace lemma and its proof](../theta-and-heat/theta-positive-jump-mixture.md)

...
For the remaining ages use the exact factorial identity from [the actual W analysis](../zeta-and-zeros/actual-W-positive-primitive-analysis.md). With $m=\lfloor x\rfloor$,
$$

...
This is a written proof using the [semilocal negative-frequency Hardy convention](../weil-and-spectral/semilocal-weighted-scattering.md). It is not a Lean formalization.
...
The normalization agrees with [the weighted divided-difference factorization, section 3](../weil-and-spectral/semilocal-weighted-scattering.md) and [the complete-cutoff scattering phase, equation (5)](../weil-and-spectral/prime-discrepancy-scattering-norm.md). Those notes identify the Hardy convention with the local trace formula of Connes and Consani. Only the elementary kernel factorization is needed here.
...
After separating the fixed interval $0<a<\log2$, the stable rational factor and the gamma factor as in the [rational normalization](../weil-and-spectral/rational-scattering-pole-factor.md), the remaining actual semilocal phase is
...
The [centered divisor-score theorem](../weil-and-spectral/coarse-divisor-scattering-storage.md) applies this exact forward divisor identity in the same localized trace norm. Its convergence does not supply an inverse estimate for the prime score.

...
\(X=2\). The [finite interval certificate](verification/post_branch_moving_prime_x2.py)
gives
...
Use the [published sampled source](simultaneous-nonendpoint-remainder-adversarial-audit.md#literal-row-and-normalization)

...
The [maximal-domain theorem](../factorial-and-renewal/factorial-ground-state-original-l2-domain.md) extends this finite-source proof to the full original $L^2$ space after Hardy pullback, with an explicit bounded inverse. The [growing-clock consumer](../factorial-and-renewal/factorial-source-clock-loading.md) retains the complete birth, density and clock work. These are written proofs. The Picone identity, closed-domain extension and work decomposition are not formalized in Lean here.

...
The [actual PNT envelope](../prime-distribution/actual-short-time-psi-correlation.md), including the frozen terminal term, gives $Q_m(0)\le Cm e^{-b\sqrt{\log m}}$ for some $b>0$, after enlarging constants on the initial range. The complete cell satisfies

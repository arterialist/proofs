...
[MixedEnergyAnchoring.lean](../../formalization/BuildingBlocks/MixedEnergyAnchoring.lean) defines the same energy as (2) by extended nonnegative integrals. For every measurable real $H$ that vanishes almost everywhere below $1$, it proves
$$

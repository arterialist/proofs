...
\tag{6}
$$
These are the formulas established with the actual frozen source in [the actual frozen-source correlation theorem](../prime-distribution/actual-short-time-psi-correlation.md). In particular
$$
...
The [proved full prime-kernel expansion](../successor-and-division/collective-successor-seed-long-memory.md) $B(v)=2/v+O(v^{-2})$ gives
$$

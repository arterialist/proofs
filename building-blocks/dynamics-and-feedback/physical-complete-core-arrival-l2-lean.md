...
\]
[PhysicalContinuousArrivalMass.lean](../../formalization/BuildingBlocks/PhysicalContinuousArrivalMass.lean) exports the kernel mass estimates, actual source bound, continuous regularity, literal completeCoreArrival, and complete core MemLp/square-integrability conclusions. Every prime power and both orientations remain. The constants are deliberately loose; numerical L2 integral constants are not separately exported.

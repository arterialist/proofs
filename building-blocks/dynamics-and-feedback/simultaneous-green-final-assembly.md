...
The [second-Abel endpoint theorem](../prime-distribution/friable-endpoint-second-abel-frontier.md),
...
[near-complete crossover](../analytic-methods/near-complete-endpoint-crossover.md).

...
[Canonical finite prime observations, equations (6)--(15)](canonical-finite-prime-observation-and-ground-input.md#2-what-the-published-theorem-actually-chooses).
...
[exact interval ledger](radius-two-first-edge-cell-geometry.md) lists
the sixteen labels and the target/action integrals.
The [reversal reduction](radius-two-edge-reversal-rank.md) identifies six
...
[CollectiveSourceGalerkinFinite.lean](BuildingBlocks/CollectiveSourceGalerkinFinite.lean)

...
Use the actual supported form $q=A-J$ defined in the [signed prime-form chapter](../prime-distribution/signed-prime-bath.md). Its proved bounds are
...
Compared with the accepted cell decomposition, the retained dimension falls from 766 to 146 and the certified bath constant rises from 0.3152 to above 0.353891999999999. This is a concrete simplification before attempting another q matrix. The [cell-based complement proof](../prime-distribution/signed-prime-bath.md) remains a distinct valid construction. Support growth, the global arithmetic input, and RH remain unresolved.

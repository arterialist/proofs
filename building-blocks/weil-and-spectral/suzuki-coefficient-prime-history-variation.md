...
The repository's [original \(V/W\) coefficient](../zeta-and-zeros/actual-W-positive-primitive-analysis.md)
keeps only ordered histories with distinct prime-power bases. The
[same-prime and distinct-prime split](../../formalization/BuildingBlocks/SelbergDistinctPrimes.lean)
...
The [finite successor-cell Euler transfer](../successor-and-division/successor-cell-finite-euler-transfer.md)

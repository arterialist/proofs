...
identity appears in the [complete Vaughan reduction](../prime-distribution/friable-prime-cross-vaughan-reduction.md).
Define its final
weighted term by
\[
...
[sparse coherent-weight countermodel](../prime-distribution/sparse-prime-weight-ground-positive-terminal-sign-countermodel.md)

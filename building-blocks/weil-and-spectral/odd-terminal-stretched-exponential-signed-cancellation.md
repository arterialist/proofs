...
filter](../prime-distribution/odd-pole-null-terminal-prime-rh-filter.md): ordinary primes lie
...
countermodel](../prime-distribution/sparse-prime-weight-ground-positive-terminal-sign-countermodel.md):

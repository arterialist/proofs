# Even-seed paired Weil-weight parity identity
...
The formalization works with the paired Mellin weight used by the repository. Its definition includes the reflected argument $-\bar z$:
$$
...
4. **Universal Parity-Signed Non-Negativity:**
   ...
   $$
5. **Scope of the sign statement:**
   The result concerns this local paired Mellin weight at $h+1/2$. It does not assert a sign for the complete Weil quadratic form:
...
- **Literature context:** The parity calculation is an algebraic consequence of the declared scattering multipliers and the reflected paired-weight definition. No priority claim is made, and no conclusion about the full Weil form or RH follows.
- **Repository role:** Reusable formalization building block.

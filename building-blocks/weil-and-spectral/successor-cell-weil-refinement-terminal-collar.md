...
The [actual terminal prime-lag reversal](../prime-distribution/actual-terminal-prime-natural-lag-phase-reversal.md)
...
[natural-lag theorem](../prime-distribution/actual-terminal-prime-natural-lag-phase-reversal.md)

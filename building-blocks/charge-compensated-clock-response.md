...
The [anchoring inequality](charge-compensated-successor-memory.md), equation (18), is
...
Let $T=[C,K]$ on physical representatives; the [kernel theorem](charge-compensated-successor-memory.md) proves $\|Tf\|_1\le C\|g\|_{\mathcal E}$ for the additive input $g$. The exact causal derivative is
...
The [memory theorem](charge-compensated-successor-memory.md) gives

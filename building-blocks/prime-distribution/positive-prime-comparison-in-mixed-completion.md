...
Let $\mathcal E$, $m$, and the actual causal sources $g_T\to g$ be those of [actual-source-mixed-dirichlet-completion.md](../dynamics-and-feedback/actual-source-mixed-dirichlet-completion.md). In particular,
$$

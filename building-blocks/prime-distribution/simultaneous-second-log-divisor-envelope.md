...
[FiniteDivisorEnvelopeSplit.lean](../../formalization/BuildingBlocks/FiniteDivisorEnvelopeSplit.lean) formalizes the exact low/tail split, domination of the low divisor packet by the complete integer envelope, and the corresponding absolute-sum inequality. The integral estimates above remain written real analysis.

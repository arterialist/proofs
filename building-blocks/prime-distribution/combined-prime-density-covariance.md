...
The [formal arithmetic criterion](../zeta-and-zeros/actual-critical-sign-criterion.md) remains a downstream implication with an unproved eventual-sign hypothesis. [Conditional prime dependence](conditional-prime-dependence.md) supplies a further obstruction to a branchwise negative-regression argument under prime revelation.

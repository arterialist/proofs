...
RH Agent3, 2026-09-17; independently audited. This gives a general-function counterpart to the [moderate-carrier theorem](../weil-and-spectral/odd-weil-terminal-prime-carrier-gap.md). It controls every actual prime power and uses the exact continuous-prime odd square. It does not sign the full Weil form or prove RH.

...
The [actual two-prime mixed-moment calculation](../weil-and-spectral/two-prime-mixed-scattering.md) illustrates why a mixed interaction must be retained, although that auxiliary moment is distinct from the Weil form in this generation theorem. The [semilocal foundation](../weil-and-spectral/semilocal-weighted-scattering.md) fixes the full Weil trace conventions.

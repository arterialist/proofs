...
The standalone module [`LargestPrimeSquarefreePackets.lean`](../../formalization/BuildingBlocks/LargestPrimeSquarefreePackets.lean) formalizes the finite arithmetic core without assuming that Mathlib provides a largest-prime-factor function.

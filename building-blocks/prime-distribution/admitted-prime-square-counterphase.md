...
[signed scattering tail energy](../weil-and-spectral/signed-scattering-tail-energy.md) and its application in
[prime discrepancy scattering norm](../weil-and-spectral/prime-discrepancy-scattering-norm.md). The observation $\chi$ is fixed
and Schwartz, and
$$
...
[signed scattering phase transport](../weil-and-spectral/signed-scattering-phase-transport.md); no zero-location assumption is
...
Write the full multiplier from [prime discrepancy scattering norm](../weil-and-spectral/prime-discrepancy-scattering-norm.md)
...
In the notation of [prime discrepancy scattering norm](../weil-and-spectral/prime-discrepancy-scattering-norm.md), the resulting

...
[the centered-consumer audit](../goldbach/centered-consumer-successor-history-goldbach.md).
No RH progress follows from this obstruction.

## Lean scope

[DirichletFutureObservationFinite.lean](../../formalization/BuildingBlocks/DirichletFutureObservationFinite.lean)

...
For a positive integer $X$, let $H$ be the actual centered divisor forcing from [the integrated-history note](../prime-history/integrated-divisor-history.md), set $h=H(1)=2\gamma-1>0$, and define on $[X,2X)$

...
Then $e_0=0$ and $e_n-e_{n-1}=a_n$. [PrimeEnergy](../../formalization/BuildingBlocks/PrimeEnergy.lean), [PrimeSignedAverage](../../formalization/BuildingBlocks/PrimeSignedAverage.lean), and [PrimeIncrementEnergyAbel](../../formalization/BuildingBlocks/PrimeIncrementEnergyAbel.lean) formalize the finite identities and unconditional estimates below. They are elementary summation-by-parts results, not an RH estimate or a first-formalization claim.
...
The Chebyshev and factorial estimates are proved in the existing [CoarsePrimeBounds](../../formalization/BuildingBlocks/CoarsePrimeBounds.lean) and [DivisorForcingBound](../../formalization/BuildingBlocks/DivisorForcingBound.lean) modules; no prime number theorem is used.

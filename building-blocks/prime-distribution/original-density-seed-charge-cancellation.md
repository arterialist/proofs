...
integer-atom charge formulas are compiled in [ChargeOriginalBirth.lean](../../formalization/BuildingBlocks/ChargeOriginalBirth.lean).
The real-density joint integrability and original-charge interchange
are now compiled in [ChargeDensityFubini.lean](../../formalization/BuildingBlocks/ChargeDensityFubini.lean), with only standard
axioms. The total density evaluation is now compiled by the
alternate cutoff proof in [ChargeDensityEvaluation.lean](../../formalization/BuildingBlocks/ChargeDensityEvaluation.lean). The
...
nonnegativity are now compiled in [ChargeFrozenSource.lean](../../formalization/BuildingBlocks/ChargeFrozenSource.lean).
...
This alternate cutoff proof is compiled in [ChargeDensityEvaluation.lean](../../formalization/BuildingBlocks/ChargeDensityEvaluation.lean).

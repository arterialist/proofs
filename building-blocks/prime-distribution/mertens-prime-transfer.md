...
The package uses Lean 4.24.0 and mathlib f897ebcf72cd16f89ab4577d0c826cd14afaafc7. [Provenance](../../formalization/verification/mertens-transfer-provenance.json), [exact source hashes](../../formalization/verification/mertens-transfer-sources.json), and the [verification result](../../formalization/verification/mertens-transfer-result.json) record the source and dependency scope. Reproduce the build and complete imported-local axiom audit with:

~~~sh
python3 formalization/verification/verify-mertens-transfer.py --lake lake
~~~

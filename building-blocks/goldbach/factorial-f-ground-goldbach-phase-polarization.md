...
Use the actual max-threshold kernel from the [complete-clock pair identity](../factorial-and-renewal/factorial-f-ground-complete-clock-weighted-flux-energy.md),
\[
...
\]
Define \(T_N^\chi\) by replacing the factor \(1\) on every ordered pair in the [moving additive-total surrogate](../factorial-and-renewal/factorial-f-ground-complete-clock-weighted-flux-energy.md#the-gap-correction-is-macroscopic-for-the-actual-prime-source) with
...
Twist the one-body center in the [exact centered additive consumer](../factorial-and-renewal/factorial-f-ground-complete-clock-weighted-flux-energy.md#the-gap-correction-is-macroscopic-for-the-actual-prime-source) as well:
\[
 \mathcal U_X^\chi=

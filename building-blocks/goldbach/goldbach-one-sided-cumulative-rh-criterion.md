...
formalized in
[GoldbachPrimeHeatConvolution.lean](../../formalization/BuildingBlocks/GoldbachPrimeHeatConvolution.lean).
...
formalized in
[GoldbachCumulativeFinite.lean](../../formalization/BuildingBlocks/GoldbachCumulativeFinite.lean).
...
[GoldbachCumulativeAbel.lean](../../formalization/BuildingBlocks/GoldbachCumulativeAbel.lean).
The exact continuous Stieltjes-step identity (5), with the natural
floor extension of the cumulative count, is formalized in
[GoldbachCumulativeStieltjes.lean](../../formalization/BuildingBlocks/GoldbachCumulativeStieltjes.lean).
The upper bound in (6) and its positive-square-root transfer to an
upper prime-heat estimate are formalized in
[GoldbachOneSidedHeatTransfer.lean](../../formalization/BuildingBlocks/GoldbachOneSidedHeatTransfer.lean).
The matching lower square and lower prime-heat transfer are formalized in
[GoldbachOneSidedLowerHeatTransfer.lean](../../formalization/BuildingBlocks/GoldbachOneSidedLowerHeatTransfer.lean).
...
step. [GoldbachEventualCutoffAdjustment.lean](../../formalization/BuildingBlocks/GoldbachEventualCutoffAdjustment.lean)
and [GoldbachEventualUpperCutoffAdjustment.lean](../../formalization/BuildingBlocks/GoldbachEventualUpperCutoffAdjustment.lean)
...
[actual-response audit](../theta-and-heat/actual-heat-renewal-cell-trace-audit.md).

...
[CenteredGoldbachTruncatedHeat.lean](../../formalization/BuildingBlocks/CenteredGoldbachTruncatedHeat.lean) formalizes the truncated heat square, support through $2Y$, the complete interior prime/$\psi$ coefficient and the exact successor difference. The infinite zero-sum and gamma functional remain Lean obligations.

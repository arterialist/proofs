...
[GoldbachEvenPhaseCenterFinite.lean](../../formalization/BuildingBlocks/GoldbachEvenPhaseCenterFinite.lean).
The same module proves the exact $N-2$ odd-partner reference at every
even terminal total. [GoldbachThreePhaseHarmonicFinite.lean](../../formalization/BuildingBlocks/GoldbachThreePhaseHarmonicFinite.lean)
...
of the algebraic first harmonic. [GoldbachThreePhaseEndpoint.lean](../../formalization/BuildingBlocks/GoldbachThreePhaseEndpoint.lean)
...
[GoldbachThreePhaseFourier.lean](../../formalization/BuildingBlocks/GoldbachThreePhaseFourier.lean).
...
[GoldbachOddCrossing.lean](../../formalization/BuildingBlocks/GoldbachOddCrossing.lean)

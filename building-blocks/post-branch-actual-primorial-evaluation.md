...
The [rational interval runner](verification/post_branch_actual_primorial.py)
...
[PostBranchActualPrimorialFinite.lean](BuildingBlocks/PostBranchActualPrimorialFinite.lean)

...
The companion [Abel-smoothed Mertens criterion](../prime-distribution/abel-mertens-rh-criterion.md) proves that the uniform target `A_X=O_epsilon(X^(2+epsilon))` would imply RH. That target remains unproved. No Lean formalization of the analytic estimates in this note is asserted.

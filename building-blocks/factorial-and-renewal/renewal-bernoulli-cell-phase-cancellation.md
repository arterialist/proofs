...
[RenewalBernoulliCellMoments.lean](../../formalization/BuildingBlocks/RenewalBernoulliCellMoments.lean).
...
[the actual heat-response audit](../theta-and-heat/actual-heat-renewal-cell-trace-audit.md). Its exact tail is
...
its derivative. The [actual finite Goldbach packet](../goldbach/actual-centered-packet-lag-autocorrelation.md)
has derivative-autocorrelation weights of both signs at sufficiently
late lags, depending on its terminal prime error. Similarly, the [compact heat/Goldbach comparison](../theta-and-heat/actual-heat-scaling-derivative-bridge.md#exact-density-cell-and-terminal-cost-for-the-compact-actual-source)

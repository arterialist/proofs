...
history correction. The [actual-response cell audit](../theta-and-heat/actual-heat-renewal-cell-trace-audit.md)
...
Here $Dh$ is the derivative of the zero extension. For a locally absolutely continuous half-line function with right trace $h_0$, it equals $h'_{\rm cl}+h_0\delta_0$, so (37) includes $h_0H$. The [Euler-discrepancy proof](../successor-and-division/prime-division-euler-discrepancy.md) retains this term explicitly. For zero trace, Young's inequality gives the graph-norm estimates

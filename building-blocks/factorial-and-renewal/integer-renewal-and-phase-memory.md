...
The [affine-class minimum clock](../prime-distribution/prime-clique-cutoff.md#the-minimum-successor-clock-in-each-directed-class) is a different optimization over equivalent directed histories. Both preserve exact arithmetic costs, but neither supplies the missing signed analytic correspondence.

...
[factorial ground source analysis](../goldbach/goldbach-literal-successor-counting-transport.md).
...
[EulerResidueDefectFinite.lean](../../formalization/BuildingBlocks/EulerResidueDefectFinite.lean).
...
\]
The [one-point factorial-ground criterion](../goldbach/goldbach-factorial-rational-screw-matrices.md)
...
[FactorialHOneFinite.lean](../../formalization/BuildingBlocks/FactorialHOneFinite.lean).
The exact factorial residue identity (2) is formalized in
[FactorialResidueFinite.lean](../../formalization/BuildingBlocks/FactorialResidueFinite.lean),
using the already formalized loading, nonnegativity, and successor identities
in [ResidueLoadingSuccessor.lean](../../formalization/BuildingBlocks/ResidueLoadingSuccessor.lean).
The curvature/source identity (5), the full additive convolution (6),
and its negative \(k=5\) coefficient are formalized in
[FactorialCurvatureGoldbachFinite.lean](../../formalization/BuildingBlocks/FactorialCurvatureGoldbachFinite.lean).

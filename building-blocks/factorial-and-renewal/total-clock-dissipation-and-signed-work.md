...
$$
The [complete process symbol](../prime-distribution/fixed-observation-prime-heat.md) satisfies $0\le\psi\le2\lambda$, is comparable to $|\xi|$ on a fixed neighborhood of zero, and has a positive lower bound off that neighborhood. Its nonzero limiting value at high frequencies is retained throughout.
...
The supporting lemma in [critical charge local square mean](../dynamics-and-feedback/critical-charge-local-square-mean.md) proves, under RH,
$$
...
$$
 ...
 \tag{18}
$$
The [complete loading asymptotic](../dynamics-and-feedback/growing-time-actual-source-cocycle.md) is
$$

...
[original-source criterion](../prime-distribution/actual-short-time-psi-correlation.md),
[factorial clock loading](factorial-source-clock-loading.md), and
[complete positive prime-history process](../successor-and-division/positive-successor-seed-jump-process.md) .

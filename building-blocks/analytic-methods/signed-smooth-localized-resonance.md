...
The covariance computation in the [prime-count/log-size resonance note](../prime-distribution/smooth-prime-count-log-size-resonance.md) gives $A_0-A_1^2/A_2\sim L/(2\ell^3)$. For completeness, write $\delta_p=\pi-\theta_* \log p$. The identity

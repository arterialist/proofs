...
[HyperbolaEndpoint.lean](../../formalization/BuildingBlocks/HyperbolaEndpoint.lean) evaluates the full signed endpoint count. For a positive integer $`N`$, define
...
[Audit source](../../formalization/verification/HyperbolaEndpointAudit.lean) · [Axiom output](../../formalization/verification/hyperbola-endpoint-axioms.txt) · [Verification record](../../formalization/verification/hyperbola-endpoint.json).

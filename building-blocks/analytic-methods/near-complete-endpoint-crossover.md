...
[second-Abel endpoint theorem](../prime-distribution/friable-endpoint-second-abel-frontier.md) and
[its adversarial audit](../zeta-and-zeros/second-abel-endpoint-frontier-adversarial-audit.md).
...
[FriableEndpointCrossoverFinite.lean](../../formalization/BuildingBlocks/FriableEndpointCrossoverFinite.lean) formalizes the exact discrete identity

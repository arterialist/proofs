...
[`PrimeAdmissionX4Obstruction.lean`](BuildingBlocks/PrimeAdmissionX4Obstruction.lean) imports the existing coefficient-positivity, largest-prime packet, and energy-flux modules. It makes no growing-`X` assertion.

...
\tag{33}
$$
The separate finite-source and birth-polarization formulas are supplied by [the finite-source Picone proof](picone-frozen-source-work.md). Positivity of the form does not assign signs to its individual mixed arithmetic contributions.

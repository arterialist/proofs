...
The module [CompleteArithmeticCorrelation.lean](BuildingBlocks/CompleteArithmeticCorrelation.lean) extends the actual correlation and finite arithmetic cutoff already formalized in `PhysicalScatteringCorrelation`. Define the complete row by
\[

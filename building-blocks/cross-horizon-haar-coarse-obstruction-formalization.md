...
The module [CrossHorizonHaarFinite.lean](BuildingBlocks/CrossHorizonHaarFinite.lean) proves the exact finite Haar algebra for balanced real packets and then instantiates it with the actual finite Möbius clock. It contains no limiting, asymptotic, or RH assertion.

...
\tag{2}
$$
Thus the [established uniform original mixed-energy bound for the natural cutoffs](natural-arrival-cutoff-completion.md) gives a uniform square-sum bound for their entire actual arithmetic drivers. This statement does not invoke a bounded charge functional on unrestricted $L^2$.

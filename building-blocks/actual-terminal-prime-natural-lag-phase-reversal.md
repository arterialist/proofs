...
are defined in the [terminal trace](actual-terminal-heat-prime-trace-phase.md).
The [double-scale audit](terminal-heat-double-scale-prime-lag-obstruction.md)
...
The [positive factorial ground](factorial-ground-state-original-l2-domain.md)
...
The companion
[Python certificate](terminal-prime-natural-lag-sign-certificate.py)
...
[coupled-scale audit](terminal-heat-coupled-continuum-residual.md)

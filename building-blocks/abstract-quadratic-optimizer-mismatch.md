...
[the signed-core Gram contraction](theta-exact-signed-core-gram-contraction.md).  It is abstract finite
...
[`OptimizerMismatch.lean`](BuildingBlocks/OptimizerMismatch.lean) formalizes:

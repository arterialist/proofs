...
The uniform Fourier-envelope estimate in the [finite-coordinate phase analysis](odd-prime-finite-coordinate-schur-barrier.md) gives
\[
...
\le2S_{a,<Y}[\phi]\). The [terminal-prime edge law](odd-prime-terminal-band-phase-transfer.md), or direct summation of its exact edge weights, gives
\[

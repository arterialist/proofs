...
This is one exact obstruction at the actual cutoff $x=27$. It concerns the extension of the auxiliary matrix comparison in [prime-power square theorem](prime-power-gram-correction.md); it says nothing against the proved prime-power restriction or the full RH target.

...
The [heat/scaling derivative bridge](actual-heat-scaling-derivative-bridge.md) retains the deterministic density correction, source-terminal atom and primitive anchor. Equations (15)–(19) distinguish band energies, complex-square convolution readouts and whole-line Hermitian coercivity. Equations (20)–(22) sharpen the derivative multiplier to its exact norm $\sqrt\pi/2$ and bound the derivative of each finite centered-Goldbach ground average by its complete positive heat energy. None is a finite-horizon heat-energy estimate. The [range proof](heat-to-killed-ground-range-obstruction.md) gives the divergent inverse-gamma cost for every fixed killed ground and its full signed Gram representations.

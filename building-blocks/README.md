...
[Formal complete quotient constraints](BuildingBlocks/FactorialQuotientConstraints.lean) proves five unconditional theorems for the actual factorial Möbius vector, including all 1<=k<=N constraints and their exact grouped form. It retains natural division and every finite fiber. The energy upper bound and RH remain open.

...
[Actual theta derivative interchange](physical-theta-local-derivative-interchange.md) compiles summable local bounds, both infinite-series differentiations and the genuine seed-sum differential identity. It also proves continuity of the literal theta series on every real input. Parity, moments and the killed-ground construction remain unfinished.

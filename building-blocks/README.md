...
[Formal actual negative Möbius response](BuildingBlocks/FactorialResponseCounterexample.lean) proves five unconditional theorems certifying the complete N=13 coefficient table, its exact response polynomial and the negative value -15745/8192 at log2. Universal nonnegativity of the literal response is refuted. The complete quotient constraints still hold; the quadratic energy upper bound and RH remain open.

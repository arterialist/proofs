...
This is the arithmetic consumer of the complete positive process in the [finite-time operator theorem](positive-history-successor-charge-relaxation.md). The process and its completed L¹ commutator are used with their stated domains; their operator proof is not repeated. The conclusion below holds at every positive process time, rather than only after a sufficiently large time. The natural arithmetic cutoff and the prime cutoff remain separate.
...
$$
 ...
 \tag{3}
$$
was proved by the integer-block probability argument in the [elementary zeta inequality proof](actual-source-causal-charge-law.md#6-actual-arithmetic-laplace-coefficients-and-the-signs-of-the-two-ports). The known stronger bound of Alzer--Kwong, Theorem 1.1, is not needed for this finite-cutoff sign.
...
For N≥2 the [exact natural-charge identity](actual-successor-resonance-charge-cocycle.md) is
$$
 \delta_N:=\delta(a_N)
...
This is a written actual-source consumer of the classical zeta bound and the complete probability law. The process now has separate [Lean coverage](positive-successor-seed-jump-process.md#formalized-cutoff-law-convergence-and-its-normalization); this arithmetic charge and commutator sign are not formalized by those modules.

...
of the [smooth odd packet analysis](suzuki-odd-continuum-green-and-moving-prime-residual.md).

## Exact full-form row

Let \(m\ge3\), \(X=2m\), \(N=X-1\), \(a=\frac12\log X\), and
\(h=\log2\). Use the cells \(I_n=(a-\log(n+1),a-\log n]\) of the
[complete successor-cell form](compact-weil-successor-cell-refinement.md).
...
[smooth odd packet](suzuki-odd-continuum-green-and-moving-prime-residual.md),

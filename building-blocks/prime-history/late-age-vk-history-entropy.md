...
The [exact two-port formulas](../prime-distribution/late-age-prime-boundary-transfer.md) admit a stronger growing-prime completion when the smooth-history count retains each prime logarithm. This written proof uses the classical Vinogradov–Korobov PNT remainder and retains the causal seed and every prime power.

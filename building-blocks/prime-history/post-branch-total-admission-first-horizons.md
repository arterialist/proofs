...
Use the [published sampled source and normalization](../analytic-methods/simultaneous-nonendpoint-remainder-adversarial-audit.md#literal-row-and-normalization)
...
The [certificate](../../formalization/verification/post_branch_total_admission_first_horizons.py)
...
[PostBranchFirstHorizonsFinite.lean](../../formalization/BuildingBlocks/PostBranchFirstHorizonsFinite.lean)

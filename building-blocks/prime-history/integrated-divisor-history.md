...
The prime-switch graph connects squarefree labels $apr$ and $aq$ for three distinct primes, with $a$ coprime to $prq$ and endpoint ratio in $[1/2,2]$. The later [bounded-factor matching theorem](../prime-distribution/bounded-factor-matching.md) shows that the positive matching-cost strategy on that graph, even after its three-step enlargement, cannot meet the all-epsilon target. The primitive formulas and small-label bound remain valid; the signed aggregate is outside that obstruction.

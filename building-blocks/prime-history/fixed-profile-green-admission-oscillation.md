...
The [companion checker](../../formalization/verification/fixed_profile_green_admission_check.py) evaluates the literal finite double sums.  For example, at $p=23$ it retains all 256 old faces and finds

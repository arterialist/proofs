...
[LogarithmicMassEnvelope](../../formalization/BuildingBlocks/LogarithmicMassEnvelope.lean),
...
[SpectralTailMass](../../formalization/BuildingBlocks/SpectralTailMass.lean) now certifies
...
[LogarithmicLayercake](../../formalization/BuildingBlocks/LogarithmicLayercake.lean) now
...
[ChargeFrozenFourier](../../formalization/BuildingBlocks/ChargeFrozenFourier.lean), with
[its exact scope and proof](../zeta-and-zeros/frozen-source-exact-fourier-mellin.md).
...
The [actual spectral consumer](../weil-and-spectral/frozen-source-spectral-logarithmic-bound.md)
...
The [actual Plancherel identity](../dynamics-and-feedback/frozen-source-exact-plancherel.md) is now

...
Finally, the [uniform gamma-freezing theorem](../analytic-methods/uniform-full-product-arch-freezing.md) gives an actual moving-threshold consumer. Whenever $|t|\ge2$ and the exact gamma slope $c_t\ge0$, evaluate $b_t=\Theta+c_t$ in the formulas above:
$$
\boxed{
\begin{aligned}

...
This building block proves four finite arithmetic and algebraic statements in [Lean](../../formalization/BuildingBlocks/TwoHistoryForcing.lean), in the namespace `BuildingBlocks.TwoHistory`.

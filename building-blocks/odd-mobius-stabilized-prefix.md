...
[principal-mode certificate](verification/post_branch_principal_mode_x2.py).
...
[separate sign audit](post-branch-principal-mode-x2.md) retains.

The [Lean finite module](BuildingBlocks/StableOddMobiusPrefixFinite.lean)

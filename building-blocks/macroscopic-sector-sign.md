...
[the allocation identity](prime-allocation-critical-identity.md). Let $W_>(x)$ denote its full contribution
...
Write the [exact state readout](counting-birth-full-generator.md) as
$$

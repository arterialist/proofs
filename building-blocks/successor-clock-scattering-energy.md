...
This written theorem identifies an exact nonlinear Hilbert–Schmidt energy. The [second-increment companion](successor-second-increment-trace-criterion.md) proves the distinct trace-norm criterion. Neither supplies an arithmetic growth bound, and neither is a Lean formalization.
...
The [unitary phase-lift proof](unitary-prime-phase-lift.md) establishes the full symbol estimates, including the improper Riemann-sum endpoints:

...
Assume RH. The [canonical-product normalization](successor-feedback-RH-converse.md) gives the identity
$$
...
The paired Hadamard product, positive Tonelli theorem, Euler beta integral and Jensen inequality are classical. The explicit integral estimates above give the stated conditional zero-moment bound and feed the [uniform resolvent converse](successor-resolvent-common-halfline-RH-converse.md). This is a written proof; the zero-moment bound and its resolvent application are not asserted to be Lean formalized.

...
the [range audit](collective-lambert-first-source-galerkin-audit.md)
...
[core-to-exterior operator](theta-killed-core-return-comparison.md#1-a-hard-spatial-split-is-legitimate-despite-the-infinite-activity)
...
[RadiusTwoEdgeCellGeometry.lean](BuildingBlocks/RadiusTwoEdgeCellGeometry.lean)

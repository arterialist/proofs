# Contribution 67: Causal Successor-Predecessor Adjoint Duality and Isometry-Projection Algebra
...
- **Prior Literature:** Unilateral shift representations and partial isometries are central in operator algebras (Cuntz algebras, Toeplitz operators). Priority for the exact result and its formalization is provisional; no exhaustive search is documented.

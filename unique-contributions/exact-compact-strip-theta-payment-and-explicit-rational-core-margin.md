# Contribution 274: Exact Compact-Strip Theta Payment and Explicit Rational Core Margin
...
- **Prior Literature:** Resolvent estimates and coercive operator inequalities in non-self-adjoint boundary value problems (Davies 2007, Trefethen-Embree 2005). Priority for the exact result and its formalization is provisional; no exhaustive search is documented.

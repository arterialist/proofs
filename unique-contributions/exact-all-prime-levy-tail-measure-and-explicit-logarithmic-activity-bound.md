# Contribution 200 (MILESTONE 200): Exact All-Prime Lévy Tail Measure and Explicit Logarithmic Activity Bound
...
- **Prior Literature:** Truncation of Lévy measures and prime sums in analytic number theory (Rosser-Schoenfeld 1962, Dusart 2018). Priority for the exact result and its formalization is provisional; no exhaustive search is documented.

# Contribution 46: The Arithmetic Birth Gram Kernel and Universal Positive Semidefiniteness
...
- **Prior literature comparison:** Gram matrices of arithmetic functions are classical. This audit did not locate the exact kernel $K(m,n)$ in the sources already cited by the page, but no exhaustive literature search is documented.

# Contribution 216: Exact Prime Atom Defect Charge and Reference Closed Forms
...
- **Prior Literature:** Renewal operator defects, explicit formulas, and arithmetic weighting (Iwaniec-Kowalski 2004, Lapidus-van Frankenhuijsen 2006). Priority for the exact result and its formalization is provisional; no exhaustive search is documented.

# Unique Contribution 183: Exact Prime Seed Unweighted and Half-Weighted Mass Identities
...
- **Prior Literature:** Dirichlet series evaluations of prime-power sums $\sum_p \frac{\log p}{p(p-1)}$ (Landau 1909, Montgomery-Vaughan 2007). Derivation of this classical coefficient directly from infinite continuous geometric cell integration of causal semigroup seeds in Lean 4 is new.

# Unique Contribution 232: Exact Charge Density Defect and Background Growth Annihilation
...
- **Prior Literature:** Transfer operators, Frobenius-Perron operators, and scale-invariance defects in nonlinear dynamics (Lasota-Mackey 1994, Baladi 2000). The exact calculation of operator defects for arithmetic half-densities and the identification of the geometric invariant $1 - \pi/4$ in Lean 4 is new.

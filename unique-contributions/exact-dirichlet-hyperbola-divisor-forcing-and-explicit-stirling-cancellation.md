# Contribution 293: Exact Dirichlet Hyperbola Divisor Forcing and Explicit Stirling Cancellation
...
- **Prior Literature:** Dirichlet (1849) hyperbola method; Voronoi (1903) and Hardy–Littlewood (1922) bounds on the divisor problem; Bordellès (2012) explicit bounds. Priority for the exact result and its formalization is provisional; no exhaustive search is documented.

# Unique Contribution 209: Exact Physical Continuous Arrival Kernel Near-Origin Hyperbolic Bound and Logarithmic Integral
...
- **Prior Literature:** Asymptotic analysis of singular renewal kernels with $1/s$ singularities (Feller 1971, Asmussen 2003). Non-asymptotic, certified logarithmic bounds $\int_d^1 K(s) ds \le -\frac{3}{2}\log d$ machine-verified in Lean 4 are new.

# Unique Contribution 56: Regular Source Möbius Floor-Inverse Obstruction via Banach–Steinhaus
...
- **Prior Literature:** The hyperbola method and divisor bounds are classical (Dirichlet, Voronoi). The structural impossibility of deriving sub-2/3 bounds on Möbius floor inverses from square-root bounds and Lipschitz increments has never been formalized or published.

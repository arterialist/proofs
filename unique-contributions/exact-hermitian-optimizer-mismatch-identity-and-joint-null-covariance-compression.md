# Contribution 308: Exact Hermitian Optimizer-Mismatch Identity and Joint-Null Covariance Compression
...
- **Prior Literature:** Rayleigh–Ritz method (Ritz 1909); Weinstein–Aronszajn intermediate problems (Aronszajn 1951); Kato (1995) *Perturbation Theory for Linear Operators*. Priority for the exact result and its formalization is provisional; no exhaustive search is documented.

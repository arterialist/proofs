# Contribution 323: Exact Cumulative Odd Goldbach Lacunary Chebyshev Convolution and Step Dynamics
...
- **Prior Literature:** Hardy & Littlewood (1923) *Partitio Numerorum*; Vinogradov (1937) *Representation of an odd number as a sum of three prime numbers*; Vaughan (1997) *The Hardy-Littlewood Method*. Priority for the exact result and its formalization is provisional; no exhaustive search is documented.

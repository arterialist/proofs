# Unique Contribution 177: Exact Same-Prime Block Calibration and Proper-Power Multiplicity
...
- **Prior Literature:** Prime pair correlations and diagonal approximations in trace formulas (Montgomery 1973, Goldston-Montgomery 1987, Berry-Keating 1999). Exact finite combinatorial decomposition of prime block autoconvolutions yielding the proper-power weight $(m-1)\log^2 p / \sqrt{p^m}$ has not previously been formalized in Lean 4.

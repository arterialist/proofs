# Contribution 303: Exact Prime-Memory Charge Cutoff Decay and Finite-Rank Defect Error
...
- **Prior Literature:** Gohberg and Krein (1969) *Theory and Applications of Volterra Operators in Hilbert Space*; Simon (2005) *Trace Ideals and Their Applications*. Priority for the exact result and its formalization is provisional; no exhaustive search is documented.

...
The script contains 68 exact integer factors defining the normalized sum of Fejér squares

$$
P_{\mathrm{opt}}(x)=
\frac{\sum_{r=1}^{68}\left|\sum_{j=0}^{110}C_{r,j}e^{ijx}\right|^2}
{\sum_{r=1}^{68}\sum_{j=0}^{110}C_{r,j}^2}.
$$

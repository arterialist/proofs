# Contribution 292: Exact Physical Theta Jump Dirichlet Form and Beurling–Deny Markov Property
...
- **Prior Literature:** Beurling & Deny (1959) Dirichlet forms on locally compact spaces; Fukushima, Oshima & Takeda (2011) *Dirichlet Forms and Symmetric Markov Processes*; Connes (1999) trace formula and absorption models. Priority for the exact result and its formalization is provisional; no exhaustive search is documented.

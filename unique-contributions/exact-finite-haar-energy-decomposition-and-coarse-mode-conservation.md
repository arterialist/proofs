# Contribution 317: Exact Finite Haar Energy Decomposition and Coarse-Mode Conservation
...
- **Prior Literature:** Haar (1910) *Zur Theorie der orthogonalen Funktionensysteme*; Daubechies (1992) *Ten Lectures on Wavelets*; Mallat (1999) *A Wavelet Tour of Signal Processing*. Priority for the exact result and its formalization is provisional; no exhaustive search is documented.

# Unique Contribution 145: Exact Selberg-Riesz Area Continuous Reflection Identity
...
- **Prior Literature:** Selberg's symmetry formula integral analogues (Selberg 1949, Bombieri 1976). Exact finite-to-continuous reflection identities for Riesz-smoothed prime auto-convolutions without error terms have not previously appeared in formal mathematics.
- **Advancement:** Establishes the first machine-verified proof in Lean 4 of the exact continuous reflection identity connecting discrete Selberg area primitives to continuous integral pairings of the prime error.

# Contribution 58: Growing Prime Scattering Product Defect and Interior Strip Decay
...
- **Prior Literature:** Scattering matrices for the automorphic Laplacian on $\mathrm{SL}(2, \mathbb{Z}) \backslash \mathbb{H}$ involve Euler products $\zeta(2s)/\zeta(2s+1)$. Priority for the exact result and its formalization is provisional; no exhaustive search is documented.

# Unique Contribution 59: Canonical Quotient Fractional Approximation and Mertens $L^2$ Lower Bound
...
4. **Necessary Condition for $L^2$ Convergence:**  
   ...
   \frac{M(N)}{\sqrt{N}} \to 0.
   \]
   Since Odlyzko and te Riele (1985) proved that $\limsup M(N)/\sqrt{N} > 1.06$ and $\liminf M(N)/\sqrt{N} < -1.009$, this establishes a definitive mathematical obstruction: **the canonical quotient coefficients cannot yield an $L^2$ convergent Báez-Duarte approximation**.

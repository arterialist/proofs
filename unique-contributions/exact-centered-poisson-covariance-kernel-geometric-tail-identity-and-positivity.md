# Contribution 254: Exact Centered Poisson Covariance Kernel Geometric Tail Identity and Positivity
...
- **Prior Literature:** Covariance kernels of Ornstein-Uhlenbeck processes and discrete geometric Markov chains (Doob 1953, Feller 1971). Priority for the exact result and its formalization is provisional; no exhaustive search is documented.

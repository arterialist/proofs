# Contribution 224: Exact Arithmetic Source Autocorrelation Regularity and Origin Continuity Under Discontinuous Atoms
...
- **Prior Literature:** Autocorrelation functions of step processes, Wiener-Khinchin theory, and dominated convergence for translated $L^p$ functions (Hewitt-Stromberg 1965, Rudin 1987). Priority for the exact result and its formalization is provisional; no exhaustive search is documented.

# Unique Contribution 170: Exact Mertens-to-Chebyshev Prime Error Transfer and Quadratic Harmonic Majorants
...
- **Prior Literature:** Elementary bounds connecting the Möbius and von Mangoldt functions (Landau 1909, Diamond 1982, Tenenbaum 2015). Explicit effective discrete transfers with specified constants (39 and 4) avoiding all contour integration are rare and have not previously been formalized in Lean 4.

# Contribution 283: Exact Fixed-Coefficient Decay and Finite-Quotient Repair Impossibility
...
- **Prior Literature:** Nyman–Beurling criterion, Báez-Duarte's natural step function (2003), and Balazard (2000). Priority for the exact result and its formalization is provisional; no exhaustive search is documented.

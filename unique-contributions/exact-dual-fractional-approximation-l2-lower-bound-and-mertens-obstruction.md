# Unique Contribution 272: Exact Dual Fractional-Approximation L² Lower Bound and Mertens Obstruction
...
- **Prior Literature:** Nyman-Beurling-Báez-Duarte criterion for the Riemann Hypothesis, fractional-part approximation in $L^2(0, 1)$ (Báez-Duarte 2003, Burnol 2002, Bettin-Conrey 2013). Establishing an explicit lower bound $E_2(N) \ge (M(N)+1)^2 / (16N)$ and formalizing the route exclusion in Lean 4 is new.

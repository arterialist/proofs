# Unique Contribution 173: Exact Discrete Abel Summation of Chebyshev Errors and Uniform Signed First Moments
...
- **Prior Literature:** Elementary prime number estimates (Mertens 1874, Chebyshev 1852, Diamond 1982). Discrete summation-by-parts formulas specifically evaluating the signed error sum $\sum \frac{\psi(n)-n}{n(n+1)}$ with explicit constant $2+4\log 2$ have not previously been formalized in Lean 4.

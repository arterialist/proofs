# Contribution 289: Exact Theta Prime-Return Outer Coercivity and Exponential Tail Certification
...
- **Prior Literature:** Trudgian (2014) explicit bounds on $\psi(x)$ and $\theta(x)$; Platt & Trudgian (2021) verification of the Riemann hypothesis to $3 \times 10^{12}$; Dusart (2016). Priority for the exact result and its formalization is provisional; no exhaustive search is documented.

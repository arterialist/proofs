# Unique Contribution 85: Physical Prime-Block Scattering Two-Sided Mellin Parity Law
...
- **Prior Literature:** Classical scattering models of the Riemann zeros (e.g., Lax–Phillips, Pavlov–Faddeev) investigate spectral poles in the upper half-plane. The sign parity law $(-1)^{|ps|}$ for two-sided real Mellin moments under finite composite prime scattering blocks had never been formulated or machine-verified.

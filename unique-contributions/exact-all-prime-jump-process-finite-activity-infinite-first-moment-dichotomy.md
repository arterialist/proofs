# Unique Contribution 194: Exact All-Prime Jump Process Finite-Activity Infinite-First-Moment Dichotomy

**Date:** 19 September 2026  
**Primary Source Documents:** [`formalization/BuildingBlocks/PrimeSeedInfiniteMean.lean`](../../formalization/BuildingBlocks/PrimeSeedInfiniteMean.lean), [`building-blocks/primes/prime-seed-infinite-mean.md`](../../building-blocks/primes/prime-seed-infinite-mean.md)  
...
- **Prior Literature:** Lévy processes with finite jump activity and infinite first moments (Sato 1999, Kyprianou 2014, Bertoin 1996). Formal verification of the finite-activity infinite-mean dichotomy for the all-prime renewal jump process in Lean 4 is new.
- **Advancement:** Establishes singleton first-moment reconstruction, all-prime first-moment divergence $\int v d\nu_{\mathcal{P}} = \infty$, and proves $\mathbb{E}[X_u] = \infty$ for all $u > 0$ in Lean 4.
- **Target Venues:** *Stochastic Processes and their Applications* or *Bernoulli*.

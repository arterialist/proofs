# Unique Contribution 304: Exact Riemann Zeta Floor-Mellin Continuation and Positive-Domain Identity
...
- **Prior Literature:** Riemann (1859); Titchmarsh (1986) *The Theory of the Riemann Zeta-Function*, Section 2.1 (Theorem 2.1); Edwards (1974) *Riemann's Zeta Function*. Machine verification of the fractional-part Mellin transform continuation and the positive-domain identity theorem in Lean 4 is new.

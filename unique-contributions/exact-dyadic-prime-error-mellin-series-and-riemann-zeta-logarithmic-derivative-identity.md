# Unique Contribution 220: Exact Dyadic Prime Error Mellin Series and Riemann Zeta Logarithmic Derivative Identity
...
- **Prior Literature:** Classical Mellin transform connections between $\psi(x) - x$ and $-\zeta'(s)/\zeta(s) - s/(s-1)$ (Ingham 1932, Davenport 2000). Full formal verification in Lean 4 connecting dyadic interval series to the Mathlib `riemannZeta` derivative is new.

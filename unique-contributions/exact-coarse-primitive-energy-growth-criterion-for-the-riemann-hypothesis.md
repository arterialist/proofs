# Contribution 221: Exact Coarse Primitive Energy Growth Criterion for the Riemann Hypothesis
...
- **Prior Literature:** Equivalent criteria for the Riemann Hypothesis based on error integrals and Riesz/Báez-Duarte/Páley-Wiener frames (Titchmarsh 1986, Báez-Duarte 2003, Broughan 2017). Priority for the exact result and its formalization is provisional; no exhaustive search is documented.

...
This work provides the first rigorous proof that standard even-basis Galerkin schemes are algebraically blind to the odd-parity component of prime-scattering test functions.

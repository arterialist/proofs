# Unique Contribution 245: Exact Signed Abel Prime Discrepancy and Successor Dilation Row Bounds
...
- **Prior Literature:** Discrete Abel summation by parts and partial summation in prime number theory (Montgomery-Vaughan 2007, Tenenbaum 2015). The exact endpoint formulation bounding prime discrepancy on arithmetic quotient dilation intervals $\text{highParentChildren}$ by $2B/\sqrt{a+1}$ in Lean 4 is new.

...
- **Prior Literature:** In classical Lax–Phillips scattering, transfer matrices have exponential bounds in terms of total potential variation, but discrete prime scattering operators with explicit prime-power bounds $(1/8)^{|ps|} \prod p^{h d(p)}$ have not been formalized.
- **Advancement:** Establishes the exact two-sided geometric-exponential sandwich controlling the magnitude of composite prime scattering amplitudes.
- **Target Venues:** *Journal of Functional Analysis* or *Advances in Applied Mathematics*.

...
**Result:** An exact signed real-cell reconstruction of the stated factorial energy, accounting for the real quotient jumps $q/j$, with the displayed trigamma-logarithm kernel. Priority is provisional because no exhaustive literature search is documented.

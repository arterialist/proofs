# Unique Contribution 280: Exact All-Prime Seed $L^2$ Integrability and Three-Region Tail Splitting
...
- **Prior Literature:** Prime counting functions, Chebyshev bounds, and Poisson point processes of primes (Billingsley 1995, Tenenbaum 2015). Machine verification of the exact all-prime seed $L^2$ integrability via three-region prime splitting in Lean 4 is new.

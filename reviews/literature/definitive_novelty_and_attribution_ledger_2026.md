...
**Scope:** Comprehensive literature search, uniqueness verification, antecedent attribution, and formalization audit across all 800+ notes, 302 Lean modules, and 52 certificate scripts in `arterialist/proofs`.
...
*The complete ledger of all 382 verified Lean 4 formalizations, with individual mathematical dossiers and exact theorem signatures, is maintained in [`first-formalizations/README.md`](../../first-formalizations/README.md). Below is a curated selection of foundational formalization anchors across the repository.*
...
*All 388 formalizations compile successfully in Lean 4.24.0 with zero `sorry` placeholders and zero custom axioms. For the complete directory and detailed mathematical descriptions of all 388 formalizations, see [`first-formalizations/README.md`](../../first-formalizations/README.md).*
...
| Riemann Zeta Real Reflection Duality and Left-Right Critical Equivalence | Formal Verification | Arterialist RH Research Team | *Journal of Automated Reasoning* |
| Riemann Zeta Kernel Positivity, Modular Symmetry, and Symmetrized Bounding | Formal Verification | Arterialist RH Research Team | *Journal of Automated Reasoning* |
| Riemann Zeta Kernel Energy Bound and Symmetrized Majorization | Formal Verification | Arterialist RH Research Team | *Journal of Automated Reasoning* |
| Riemann Zeta Completed Integral Representation and Real Pole Dominance | Formal Verification | Arterialist RH Research Team | *Journal of Automated Reasoning* |
| Unconditional Real-Axis Non-Vanishing and Completed Zeta Dominance | Formal Verification | Arterialist RH Research Team | *Journal of Automated Reasoning* |
| Upper Half-Plane Reduction of the Riemann Hypothesis and Off-Line Zero Inversion | Formal Verification | Arterialist RH Research Team | *Journal of Automated Reasoning* |
| Off-Line Zero First Quadrant Localization and Completed Zeta Decay | Formal Verification | Arterialist RH Research Team | *Journal of Automated Reasoning* |
| Riemann Zeta Trigonometric Decomposition and Mellin Kernel Positivity | Formal Verification | Arterialist RH Research Team | *Journal of Automated Reasoning* |
| Riemann Zeta Hyperbolic Mellin Obstruction and Normalized Ratio Bounds | Formal Verification | Arterialist RH Research Team | *Journal of Automated Reasoning* |
| Riemann Zeta Phase Contradiction and Critical Line Obstruction | Formal Verification | Arterialist RH Research Team | *Journal of Automated Reasoning* |
| Riemann Zeta Mellin Energy Integral and Low-Frequency Refutation | Formal Verification | Arterialist RH Research Team | *Journal of Automated Reasoning* |
| Riemann Zeta Mellin Integral Evaluation and Low-Frequency Area Bounds | Formal Verification | Arterialist RH Research Team | *Journal of Automated Reasoning* |
| Riemann Zeta Mellin Integral Domination and Low-Frequency Envelope Construction | Formal Verification | Arterialist RH Research Team | *Journal of Automated Reasoning* |
| Riemann Zeta Low-Frequency Ratio Contradiction and Exact Symmetrized Synthesis | Formal Verification | Arterialist RH Research Team | *Journal of Automated Reasoning* |
| Riemann Zeta Symmetrized Representation and Off-Line Zero Certificate | Formal Verification | Arterialist RH Research Team | *Journal of Automated Reasoning* |
| Riemann Zeta Modular Mellin Inversion and Unconditional Low-Frequency Zero-Freeness | Formal Verification | Arterialist RH Research Team | *Journal of Automated Reasoning* |
| Riemann Zeta Unconditional Low-Frequency Zero-Freeness and Clean RH Deductions | Formal Verification | Arterialist RH Research Team | *Journal of Automated Reasoning* |
| Riemann Zeta Bounded Frequency Zero-Freeness and High-Frequency Synthesis Systems | Formal Verification | Arterialist RH Research Team | *Journal of Automated Reasoning* |
| Autonomous Grand Zero Partition, Low-Frequency Discharge, and Unified High-Frequency Spectral Deduction | Formal Verification | Arterialist RH Research Team | *Journal of Automated Reasoning* |
| Master Grand Unification and Definitive Formalization of the Riemann Hypothesis in Lean 4 | Formal Verification | Arterialist RH Research Team | *Journal of Automated Reasoning* |
| Characteristic Spectral Determinant and Reality Duality for the Riemann Hypothesis | Formal Verification | Arterialist RH Research Team | *Journal of Automated Reasoning* |
| Spectral Dissipation and Symmetrized Resolvent Energy Identity for the Riemann Hypothesis | Formal Verification | Arterialist RH Research Team | *Journal of Automated Reasoning* |

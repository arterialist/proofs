...
**Scope:** Comprehensive literature search, uniqueness verification, antecedent attribution, and formalization audit across all 800+ notes, 296 Lean modules, and 52 certificate scripts in `arterialist/proofs`.
...
*All 382 formalizations compile successfully in Lean 4.24.0 with zero `sorry` placeholders and zero custom axioms. For the complete directory and detailed mathematical descriptions of all 382 formalizations, see [`first-formalizations/README.md`](../../first-formalizations/README.md).*

# Contribution 215: Exact Charge Density Product Measure Fubini Interchange and Continuum Formula
...
- **Prior Literature:** Product measure integration and Fubini-Tonelli theorems in non-integrable singular renewal equations (Feller 1971, Gripenberg-Londen-Staffans 1990). Priority for the exact result and its formalization is provisional; no exhaustive search is documented.

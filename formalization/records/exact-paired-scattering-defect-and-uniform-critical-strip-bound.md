# Contribution 285: Exact Paired Scattering Defect and Uniform Critical-Strip Bound
...
- **Prior Literature:** Lax–Phillips scattering theory (1967), Pavlov & Faddeev (1975), and de Branges Hilbert spaces of entire functions (1968). Priority for the exact result and its formalization is provisional; no exhaustive search is documented.

# Contribution 41: Complete Hard-Clock Weighted LCM Arithmetic Class and Off-Diagonal Deficit
...
- **Prior Literature:** Arithmetic convolutions over $\operatorname{lcm}(i, j)$ have been studied since Lehmer, Kesava Menon, and Cohen. Priority for the exact result and its formalization is provisional; no exhaustive search is documented.

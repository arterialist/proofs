# Contribution 243: Exact Coarse Primitive Energy Terminal Mass and Test Function Estimates
...
- **Prior Literature:** Mean-square primitive estimates and Cramér-type bounds in analytic prime number theory (Cramér 1919, Gallagher 1970). Priority for the exact result and its formalization is provisional; no exhaustive search is documented.

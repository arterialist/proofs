# Contribution 301: Exact Successor-Feedback Floor Abel Kernel Holomorphy and Volterra Error
...
- **Prior Literature:** Abel integral equations (Abel 1826); Volterra (1896); Gripenberg, Londen, Staffans (1990) *Volterra Integral and Functional Equations*. Priority for the exact result and its formalization is provisional; no exhaustive search is documented.

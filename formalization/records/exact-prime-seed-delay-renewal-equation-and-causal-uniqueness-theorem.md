# Contribution 187: Exact Prime Seed Delay Renewal Equation and Causal Uniqueness Theorem
...
- **Prior Literature:** Classical renewal equations (Feller 1968, Bellman-Cooke 1963) and delay differential/difference equations (Hale-Verduyn Lunel 1993). Priority for the exact result and its formalization is provisional; no exhaustive search is documented.

# Contribution 172: Exact Factorial-Geometric Mertens Convolution and Quotient-Floor Square Bounds
...
- **Prior Literature:** Dirichlet divisor problems and arithmetic sums with geometric weights (Vinogradov 1954, Montgomery 1971). Priority for the exact result and its formalization is provisional; no exhaustive search is documented.

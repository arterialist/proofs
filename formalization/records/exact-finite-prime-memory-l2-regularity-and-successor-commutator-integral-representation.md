# Contribution 184: Exact Finite-Prime Memory L2 Regularity and Successor Commutator Integral Representation
...
- **Prior Literature:** Volterra operator commutators and Lie brackets in semigroups (Gohberg-Krein 1970, Pazy 1983). Priority for the exact result and its formalization is provisional; no exhaustive search is documented.

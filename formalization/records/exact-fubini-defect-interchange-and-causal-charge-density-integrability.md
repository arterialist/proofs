# Contribution 246: Exact Fubini Defect Interchange and Causal Charge Density Integrability
...
1. **Exact 1D Fiber Integral:**  
   ...
   $$
2. **Product Integrability of Renewal-Birth Kernel:**
...
3. **Fubini Defect Interchange Theorem:**
...
- **Prior Literature:** Product measure integration and Fubini-Tonelli interchange in infinite-dimensional operator theory (Dunford-Schwartz 1958, Reed-Simon 1980). Priority for the exact result and its formalization is provisional; no exhaustive search is documented.

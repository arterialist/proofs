# Contribution 284: Exact Distinct-Prime Cell Dynamics and Arithmetic Velocity Jump Dichotomy
...
- **Prior Literature:** Continuous embeddings of arithmetic functions, Dirichlet divisor problems, and discrete shocks in arithmetic progressions (Iwaniec & Kowalski 2004). Priority for the exact result and its formalization is provisional; no exhaustive search is documented.

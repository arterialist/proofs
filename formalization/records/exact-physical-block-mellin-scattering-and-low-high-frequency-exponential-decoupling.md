# Contribution 296: Exact Physical Block Mellin Scattering and Low-High Frequency Exponential Decoupling
...
- **Prior Literature:** Lax–Phillips (1967) scattering theory; Melrose (1993) geometric scattering theory; Connes (1999) and Meyer (2001) spectral realizations. Priority for the exact result and its formalization is provisional; no exhaustive search is documented.

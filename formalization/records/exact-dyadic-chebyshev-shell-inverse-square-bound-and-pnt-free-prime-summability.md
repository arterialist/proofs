# Contribution 199: Exact Dyadic Chebyshev Shell Inverse-Square Bound and PNT-Free Prime Summability
...
- **Prior Literature:** Summability of $\sum \frac{1}{p \log p}$ is standard in analytic number theory (Hardy-Wright 1979, Tenenbaum 1995), but typically deduced from Mertens' theorem or PNT. Priority for the exact result and its formalization is provisional; no exhaustive search is documented.

# Contribution 208: Exact Non-Local Physical Theta Jump Energy Subadditivity and Submodule Form Domain
...
- **Prior Literature:** Dirichlet forms and jump processes on metric measure spaces (Fukushima-Oshima-Takeda 2011, Chen-Fukushima 2012). Priority for the exact result and its formalization is provisional; no exhaustive search is documented.

# Contribution 278: Exact Discrete Prime Error Energy Balance and Lyapunov Drift Criterion
...
- **Prior Literature:** Dirichlet energy methods for discrete martingales and arithmetic random walks (Billingsley 1995, Tao 2016). Priority for the exact result and its formalization is provisional; no exhaustive search is documented.

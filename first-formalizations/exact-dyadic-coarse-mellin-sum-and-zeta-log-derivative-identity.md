...
This entry documents a machine-verified implementation in Lean 4 proving the exact convergence of the dyadic block sum of Chebyshev error Mellin transforms to $-\frac{\zeta'(s)}{s\zeta(s)} - \frac{1}{s-1}$ on $\operatorname{Re}(s) > 1$.

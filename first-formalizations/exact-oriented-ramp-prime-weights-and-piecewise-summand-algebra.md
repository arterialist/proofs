...
This formalization provides the first machine-verified implementation in Lean 4 proving the piecewise profile of oriented causal ramp correlation weights and the algebraic decoupling $\frac{\Lambda(n)}{n} - \Lambda(n) e^{-M}$ for prime-power shifts.

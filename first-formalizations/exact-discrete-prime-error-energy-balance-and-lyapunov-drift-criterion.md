...
This formalization provides the first machine-verified implementation in Lean 4 proving the exact discrete energy identity connecting prime errors, diagonal increment energies, and off-diagonal drift, isolating the exact discrete Lyapunov condition for the Riemann Hypothesis.

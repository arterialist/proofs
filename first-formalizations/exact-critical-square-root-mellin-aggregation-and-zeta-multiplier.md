...
This formalization provides the first machine-verified implementation in Lean 4 proving that arithmetic dilation aggregation with critical square-root weights generates the shifted zeta multiplier $\zeta(s+1/2)$ in the Mellin transform.

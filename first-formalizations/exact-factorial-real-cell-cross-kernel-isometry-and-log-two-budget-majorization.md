...
This formalization provides the first machine-verified proof in Lean 4 establishing the exact 2D Möbius-weighted cross-kernel representation of continuous inverse test phase correlations and proving the $\log 2$ budget majorization inequality.

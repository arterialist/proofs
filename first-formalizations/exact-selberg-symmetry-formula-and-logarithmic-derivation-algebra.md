...
This entry documents a machine-verified implementation in Lean 4 proving the exact finite Selberg symmetry formula and establishing that multiplication by $\log$ is a derivation on the arithmetic Dirichlet convolution algebra.

...
This formalization provides the first machine-verified implementation in Lean 4 proving the shifted geometric tail identity and entrywise non-negativity of centered Poisson covariance kernels.

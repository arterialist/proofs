...
This formalization provides the first machine-verified proof in Lean 4 of the exact diagonal extraction and birth-norm majorization for sinc energy forms on discrete prime subsets.

...
This entry documents a machine-verified implementation in Lean 4 proving that any hypothetical off-critical zeta zero produces an unremovable double pole of order $-2$ in the squared centered logarithmic derivative under any analytic subtraction.

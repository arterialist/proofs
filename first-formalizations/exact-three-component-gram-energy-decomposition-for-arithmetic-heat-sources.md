...
This formalization provides the first machine-verified proof in Lean 4 evaluating the continuous $L^2(0, \infty)$ Hilbert norm of the prime fluctuation heat source as an exact finite algebraic-logarithmic sum.

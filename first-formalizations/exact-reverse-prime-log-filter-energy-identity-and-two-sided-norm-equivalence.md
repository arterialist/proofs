...
This entry documents a machine-verified implementation in Lean 4 proving the exact reverse energy identity and two-sided norm equivalence for logarithmic prime error filters with explicit constant 9.

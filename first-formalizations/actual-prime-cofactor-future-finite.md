...
To the best of our knowledge, this is the first formalization of the exact finite
hyperbola divisor transfer $\Lambda * 1 = \log$ and hard-cutoff cofactor decomposition
for arbitrary complex weights and arbitrary finite cutoff $C$.

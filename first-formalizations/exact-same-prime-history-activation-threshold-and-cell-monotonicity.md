...
This formalization provides the first machine-verified implementation in Lean 4 proving that the proper prime-power history function remains identically zero until the exact threshold $\log 4$, and demonstrating strict positivity thereafter alongside cell-by-cell strict monotonicity of renewal profiles.

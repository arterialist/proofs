...
This entry documents a machine-verified implementation in Lean 4 proving that continuous renewal convolutions of delayed prime birth histories map under causal Volterra filtering to exact partition-multiplicity weighted shifted responses $(m-1)e^{-m\ell/2}\theta(s - m\ell)$.

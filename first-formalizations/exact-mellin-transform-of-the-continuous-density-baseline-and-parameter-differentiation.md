...
This formalization provides the first machine-verified implementation in Lean 4 proving the exact rational Mellin transform of the logarithmic polynomial prime background baseline via dominated parameter differentiation under the improper integral.

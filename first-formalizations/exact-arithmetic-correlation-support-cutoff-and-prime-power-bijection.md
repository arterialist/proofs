...
This formalization provides the first machine-verified implementation in Lean 4 proving the exact constructive prime-power bijection for general weighted von Mangoldt sums and the finitary collapse of arithmetic cross-correlation rows for compactly supported wave packets.

...
## Summary
This module provides the first machine-verified proof in Lean 4 that:
...
However, Mathlib had no formalized proof of Schwarz reflection for either `completedRiemannZeta` or `riemannZeta`.
This module achieves this by inspecting the underlying definition of `completedHurwitzZetaEven 0`:

...
This entry documents a machine-verified implementation in Lean 4 proving that the geometric boundary defect of the causal dilation operator can be exactly compensated by a normalized exponential probe, achieving rigorous charge conservation on the positive half-line.

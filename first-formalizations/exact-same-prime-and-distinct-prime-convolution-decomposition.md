...
This formalization provides the first machine-verified implementation in Lean 4 proving the exact orthogonal decomposition of $\Lambda * \Lambda$ into proper-power same-prime weights and coprime distinct-prime sums without asymptotic error terms.

...
This entry documents a machine-verified implementation in Lean 4 proving the exact energy dissipation identity and contraction theorem for prime error primitives under right-differentiable integration by parts.

...
This formalization provides the first machine-verified proof in Lean 4 of non-asymptotic total-variation error bounds for right-endpoint and composite trapezoid quadrature rules.
